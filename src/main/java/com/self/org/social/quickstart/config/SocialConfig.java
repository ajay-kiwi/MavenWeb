...
public class SocialConfig {
	...
	@Autowired
	protected com.self.org.config.Configuration env;
	...
	public ConnectionFactoryLocator connectionFactoryLocator() {
		String fbp = env.get("fb.public.key");
		String fbs = env.get("fb.secret.key");

		ConnectionFactoryRegistry registry = new ConnectionFactoryRegistry();
		registry.addConnectionFactory(new FacebookConnectionFactory(fbp, fbs));
		return registry;
	}
