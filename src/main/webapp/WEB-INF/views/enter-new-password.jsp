		...
		<!-- Lower Navigation Starts -->
			...
			<div class="low-nav-bg">
				...
				<div class="main-container">
					...
					<div class="logo-bg">
					<div class="logo"><a href="index.html"><img src="/resources/images/pollinater-logo.png" alt="pollinater logo"></a>
                    </div>
          			</div>
...
<div class="cls"></div>
		...
		<div class="mid-panel1">
            <div class="container">
                ...
                <form role="form">
                      <div class="form-group">
                      <div class="forgot-txt">Enter a New Password</div>
                      <div class="divider"><hr></div>
                        <input type="password" class="form-control1 pass" id="exampleInputEmail1" placeholder="New Password">
                          <input type="password" class="form-control1 pass" id="exampleInputEmail1" placeholder="Confirm New Password">
                      </div>
                     
                    
                     <button type="submit" class="submit-btn btn-sm" data-toggle="modal" data-target="#myModal"></button>
                      <div class="modal fade" id="myModal">
                          <div class="modal-dialog">
                            <div class="modal-content">
                           
                              <div class="modal-body">
                                <p class="modal-text">Your password has been changed successfully.</p>
