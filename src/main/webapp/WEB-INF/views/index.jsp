	...
	<head>
		...
		<title>Welcome to Pollinater</title>
          ...
          <link href="/resources/css/icon-font.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="">ABOUT POLLINATER </a></li>
                    <li><a href="">SUBMIT PROJECTS </a></li>
                    <li><a href="">RAISE FUNDING</a></li>
                    <li><a href="">CONTACT US</a></li>
                    <li><font color="#83b964"><a href="#login_form" id="jointop">LOGIN </a>/ <a href="#signup_form" id="jointop">SIGN UP</a></font></li>
                </ul>
			</div>
...
<!--end of error state -->
        ...
        <div class="carousel-inner">
            <div class="item">
                <div class="fill" style="background-image:url('/resources/images/pollinater-banner.png');"></div>
				...
				<div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 hero-feature">
                        <div class="thumbnail">
                            ...
                            <div class="icon-box"><div data-icon="c" class="icon"></div>
          <input type="text" readonly="readonly" value="c"></div>
                        ...
                        <div class="thumbnail">
                           ...
                           <div class="caption">
                                ...
                                <div class="cls"></div>
                                 <div class="lower-box">
                            <div class="icon-text"><img src="/resources/images/icon.png"> <span>Fundable</span></div>
                            <div class="icon-box"><div class="icon icon-heart"></div></div>
