	...
	<body>
		...
		<div class="mid-panel">
            ...
            <div class="headRow5">MY ACCOUNT</div>
                  <ul class="side-nav nav-sidebar">
            ...
            <div class="col-sm-9 col-md-9 sidebar ">
                 <div class="user-dash-txt">Change Password</div>
                    ...
                    <form role="form">
                      ...
                      <div class="col-md-12">
                        <label for="exampleInputEmail1" class="cont-txt">Current Password<font color="red">*</font></label>
                        <input type="password" class="form-control-txt" id="exampleInputEmail1" placeholder="Current Password">
                      </div>
                      ...
                      <div class="col-md-6">
                        <label for="exampleInputEmail1" class="cont-txt">New Password<font color="red">*</font></label>
                        <input type="password" class="form-control-txt" id="exampleInputEmail1" placeholder="New Password">
                      </div>
                      <div class="col-md-6">
                       <label for="exampleInputEmail1" class="cont-txt">Confirm New Password<font color="red">*</font></label>
                        <input type="password" class="form-control-txt" id="exampleInputEmail1" placeholder="Confirm New Password">
                      ...
                      <div class="col-md-12">
                      <div class="req-field fr">* Required Fields</div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="back-txt"><a href=""><< Back</a></div>
                      </div>
                      <div class="col-md-6">
                        <button type="submit" class="btn btn-primary fr">SAVE</button>
                      </div>
